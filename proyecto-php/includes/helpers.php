...
$borrado = false;
    ...
    if(isset($_SESSION['errores_ent'])){
        $_SESSION['errores_ent'] = null;
        $borrado = true;
...
function conseguirEntradas($conexion ){
    ...
    function conseguirPerfil($conexion){
        ...
        function conseguirTodasLasEntradas($conexion, $limit = null, $categoria = null, $busqueda=null){
            ...
            function conseguirEntrada($conexion, $id){
                ...
                if($entrada == true && mysqli_num_rows($entrada)>= 1){
